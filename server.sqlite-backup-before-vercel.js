...
function convertSql(sql) {
  ...
  sql = sql.replace(
    /INSERT OR IGNORE INTO\s+([a-zA-Z0-9_]+)/gi,
    'INSERT INTO $1'
  );
...
async function init(){
  ...
  if(count.n===0){
    const books=[
      ...
      ['BK-0024','9789712360001','Filipino sa Ibaâ€™t Ibang Disiplina','Various','Filipino','General Education','Rex',2021,5,'Filipino language across disciplines.',['GENED','BSEd','BEEd']],
